testthat::test_that("Testing find_blood_transfusion function for case 1", {
  ...
  output_df <- data.frame(
    ...
    max_ssd = c("2015-01-20", "2015-02-10", "2016-02-29", "2017-02-23", "2017-01-08"),
    ClaimNumber = c("25", "20", "11", "28", "30"),
    blood_transfusion = c(1, 1, 1, 1, 1),
    stringsAsFactors = FALSE
  )
  testthat::expect_equivalent(output_df, check_if_blood_transfusion(data_df, blood_transfusion_claims, "36430"))
})
