context("Testing Get Readmissions Function")

testthat::test_that("Checking if the grouping is correct for threshold 10 and readmissions are perfect", {
  data_df <- data.frame(
  ...
  output_df <- data.frame(
    ...
    min_ssd = c("2015-01-01", "2016-02-02", "2017-01-01", "2017-01-08"),
    max_ssd = c("2015-01-20", "2016-02-29", "2017-02-23", "2017-01-08"),
    length_of_stay = c(20, 28, 54, 1),
    readmission = c(1, 0, 0, 0),
    stringsAsFactors = FALSE
  )
  expect_equal(output_df, get_readmissions(data_df, threshold), check.attributes = FALSE)
})

testthat::test_that("Checking if the grouping is correct for threshold 10 and greater
                    than 30 days and readmissions are perfect", {
  data_df <- data.frame(
    UPIN = c("A", "B", "A", "A", "A", "A","B", "B", "C", "D"),
    ServiceStartDate = c('2015-01-01', '2016-02-02', '2015-01-04', '2015-01-06', '2015-01-12', '2015-01-31', '2016-02-03', '2016-02-23', '2017-01-01', '2017-01-08'),
    ServiceEndDate = c('2015-01-05', '2016-02-15', '2015-01-08', '2015-01-10', '2015-01-20', '2015-02-10', '2016-02-14', '2016-02-29', '2017-02-23', '2017-01-08'),
  ...
  expect_equal(output_df, get_readmissions(data_df, threshold, lowerbound = lowerbound,
                                           upperbound = upperbound), check.attributes = FALSE)
})
